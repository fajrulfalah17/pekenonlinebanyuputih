                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="row">
                          ...
                          @endforeach
                          <div class="col-12">
                            <!-- input type file digunakan agar ketika klik add photo akan menambahkan foto yg dipilih, display none agar tidak terlihat, menyambung ke script javascript DOM menggunakan function thisFileUpload() -->
